...
export const navItems: NavItem[] = [
  ...
  { label: "Extension Registry", path: "/inspections", allowedRoles: ["DIRECTOR", "ADMIN", "FISHERIES_OFFICER"] },
  ...
  { label: "Analytics", path: "/analytics", allowedRoles: ["DIRECTOR", "ADMIN", "DATA_ANALYST", "FISHERIES_OFFICER"] },
