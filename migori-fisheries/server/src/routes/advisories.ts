...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const where =
      req.user.role === "FISHERIES_OFFICER" || req.user.role === "FARMER"
        ? {
...
router.post(
  ...
  auditLog("ADVISORY"),
  asyncHandler(async (req, res) => {
    const payload = req.body as z.infer<typeof createAdvisorySchema>;
...
router.put(
  ...
  asyncHandler(async (req, res) => {
    ...
    const payload = req.body as z.infer<typeof updateAdvisorySchema>;
